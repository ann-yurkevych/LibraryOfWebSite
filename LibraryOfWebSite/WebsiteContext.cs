...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Country>(entity =>
        {
            ...
            entity.HasOne(d => d.ProductManufactures).WithMany(p => p.Countries)
                .HasForeignKey(d => d.ProductManufacturesId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Countries_ProductManufactures");
        });
        ...
        modelBuilder.Entity<Material>(entity =>
        {
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.Materials)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Materials_Products");
        });
        ...
        modelBuilder.Entity<ProductManufacture>(entity =>
        {
            ...
            entity.HasOne(d => d.Products).WithMany(p => p.ProductManufactures)
                .HasForeignKey(d => d.ProductsId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ProductManufactures_Products");
        });
